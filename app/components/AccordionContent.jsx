    ...
    <div className='p-8 dark:bg-slate-700'>
        ...
        <Accordion defaultExpandedKeys={["1"]}>
            ...
            <AccordionItem key="3" aria-label="Accordion 3" subtitle="Clique para abrir" title="Avaliações digitais" className="hover:bg-sky-100 transition-colors duration-200 rounded-lg px-4 font-bold dark:hover:bg-sky-700">
                <iframe src="https://sites.google.com/beieducacaopedagogico.com/aluno6oano?usp=sharing#h.o5i6rkw6s4zi" width="100%" height="600" seamless="seamless" scrolling="no" frameBorder="0" allowFullScreen allow="autoplay; clipboard-read; clipboard-write"></iframe>
            </AccordionItem>
